#!/usr/bin/env python
#coding:utf-8
# data.py - store data and provide access to db file.
...
class Querys(object):
    ...
    def __init__(self, dbname=None, check_same_thread=True):
        if dbname and os.path.isfile(dbname):
            self.con = sqlite3.connect(dbname, check_same_thread)
